...
import com.hblolj.wx_demo.dto.TextMessage;
import com.hblolj.wx_demo.properties.WeiXinProperties;
import com.hblolj.wx_demo.utils.CheckUtil;
import com.hblolj.wx_demo.utils.MessageUtil;
...
import static com.hblolj.wx_demo.constant.WeiXinMessageConstants.*;
...
public class WeiXinMessageMutual {
    ...
    public void validate(HttpServletRequest req, HttpServletResponse resp, @RequestParam String signature,
        ...
        try {
            out = resp.getWriter();
            if(CheckUtil.checkSignature(signature,timestamp,nonce, weiXinProperties.getToken())){
                out.print(echostr);
            }
        } catch (IOException e) {
            e.printStackTrace();
